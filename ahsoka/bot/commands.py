...
def register_bot_commands(
    ...
    async def cmd_help(message: Message, state: FSMContext) -> None:
        ...
        lines = [
            ...
            "",
            "Filter settings:",
            "  /setkeywords <words> - Set keyword filter",
            "  /addkeyword <words> - Add keywords",
            "  /resetkeywords - Clear all keywords",
            "  /setthreshold <0-10> - Minimum score",
            "  /setstack <stack> - Tech stack preference",
            "  /setseniority <level> - Seniority level",
            "  /setremote <mode> - Work mode",
            "  /setlocation <place> - Location preference",
            "  /setsalary <min> <max> - Salary range",
            "",
            "Channels & notifications:",
            "  /watch - Forward a msg to add a watch channel",
            "  /notify - Forward a msg to set notification channel",
            "  /notify dm - Send notifications to DM",
